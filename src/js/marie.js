...
(function() {
    ...
    /**
     * MarieSimError - Error class for MarieSim.
     *
     * @constructor
    ...
    /**
     * MarieSim.prototype.restart - Restarts the simulator machine.
     *
     * @function
     * @this {MarieSim}
     */
    ...
    /**
     * MarieSim.prototype.toJSON - Serialises the current state of MARIE machine into a
     * JSON object.
     *
     * @function
     * @this {MarieSim}
    ...
    /**
     * MarieSim.prototype.setEventListener - Set the event listener to call function once
     * the event is fired.
     *
     * @function
     * @this {MarieSim}
    ...
    /**
     * MarieSim.prototype.current - Returns the current instruction from memory.
     *
     * @function
     * @this {MarieSim}
    ...
    /**
     * MarieSim.prototype.regSet - Performs a RTL operation that sets the target the value
     * of the source.
     *
     * @function
     * @this {MarieSim}
    ...
    /**
     * MarieSim.prototype.regAdd - Performs a RTL operation that adds/subtracts
    ...
    /**
     * MarieSim.prototype.run - Runs the simulator machine.
    ...
    /**
     * MarieSim.prototype.step - Fetches and decodes only one instruction per
     * step.
     *
     * @function
     * @this {MarieSim}
    ...
    /**
     * MarieSim.prototype.microStep - Performs one RTL operation
    ...
    /**
     * MarieSim.prototype.fetch - Performs the fetch part of the
    ...
    /**
     * MarieSim.prototype.decode - Performs the decode part of the
     * fetch-decode-execute cycle.
     *
     * @function
     * @this {MarieSim}
    ...
    /**
     * MarieSim.prototype.operators - A dictionary of operators which each
    ...
    /**
     * MarieAsmError - An error constructor for MarieAsm class.
     *
     * @constructor
     * @param  {string} name       The name of the error.
     * @param  {number} lineNumber Which line caused the error.
    ...
    /**
     * MarieAsm - Compiles MARIE Assembly code to be used by MarieSim.
     *
     * @constructor
     * @this {MarieAsm}
    ...
    /**
     * MarieAsm.prototype.assemble - Assembles the program.
     *
     * @function
     * @this {MarieAsm}
